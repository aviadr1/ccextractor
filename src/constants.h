...
enum ccx_stream_type
{
	...
	CCX_STREAM_TYPE_MPEG_PACKETS = 0x07,
...
enum ccx_output_date_format
{
	...
	CCX_ODF_SECONDS = 2,
	CCX_ODF_DATE =3,
	CCX_ODF_HHMMSSMS = 4, // HH:MM:SS,MILIS (.srt style)
};
...
{
    CCX_BUFFERDATA_TYPE_UNKNOWN = 0,
    CCX_BUFFERDATA_TYPE_PES = 1,
    CCX_BUFFERDATA_TYPE_RAW = 2,
    CCX_BUFFERDATA_TYPE_H264 = 3,
	CCX_BUFFERDATA_TYPE_HAUPPAGE = 4,
	CCX_BUFFERDATA_TYPE_TELETEXT = 5,
	CCX_BUFFERDATA_TYPE_PRIVATE_MPEG2_CC = 6
};

enum ccx_video_frame_type
{
    CCX_VIDEO_FRAME_TYPE_RESET_OR_UNKNOWN = 0,
    CCX_VIDEO_FRAME_TYPE_I_FRAME = 1,
    CCX_VIDEO_FRAME_TYPE_P_FRAME = 2,
    CCX_VIDEO_FRAME_TYPE_B_FRAME = 3,
    CCX_VIDEO_FRAME_TYPE_D_FRAME = 4
};

...
GF_Err gf_saf_mux_stream_add(GF_SAFMuxer *mux, u32 stream_id, u32 ts_res, u32 buffersize_db, u8 ccx_stream_type, u8 object_type, char *mime_type, char *dsi, u32 dsi_len, char *remote_url);

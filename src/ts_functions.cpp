...
void init_ts_constants(void)
{
	...
	desc[CCX_STREAM_TYPE_MPEG_PACKETS] = "MHEG Packets";
...
unsigned get_printable_stream_type (unsigned ccx_stream_type)
{
	...
	switch (ccx_stream_type)
    {
		...
		case CCX_STREAM_TYPE_MPEG_PACKETS:
...
LLONG ts_getmoredata(void)
{
    ...
    do
    {
		...
		if (bufferdatatype == CCX_BUFFERDATA_TYPE_PRIVATE_MPEG2_CC)
		{

...
extern struct ccx_gop_time_code gop_time, first_gop_time, printed_gop;
...
extern LLONG inbuf;
extern int bufferdatatype; // Can be CCX_BUFFERDATA_TYPE_RAW or CCX_BUFFERDATA_TYPE_PES
...
// ccextractor.cpp
LLONG calculate_gop_mstime (struct ccx_gop_time_code *g);
void set_fts(void);
LLONG get_fts ( void );
LLONG get_fts_max ( void );
char *print_mstime( LLONG mstime );
